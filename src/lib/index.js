...
var Show = function Show(_ref) {
  ...
  return React.createElement(posed.PoseGroup, _extends({
    flipMove: flipMove,
...
var ErrorContainer = function ErrorContainer(_ref6) {
  var className = _ref6.className,
      name = _ref6.name;
  return React.createElement(formik.ErrorMessage, {
    name: name,
...
var DateInputField = formik.connect(DateInputFieldRaw);
